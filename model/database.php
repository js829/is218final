<?php
	...
	$database = 'js829';		// This should be your UCID (same as username)
	$username = 'js829';		// This should be your UCID (same as database name)
	$password = 'NhOG2kr3';	// This is your NJIT mySQL password. It is likely different from your UCID password.
